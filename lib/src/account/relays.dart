...
class Relays {
  ...
  Future<void> init({String? circleRelay, ValueChanged<bool>? circleConnectCallback}) async {
    ...
    if (circleRelay != null) {
      Connect.sharedInstance
          .connectRelays([circleRelay], relayKind: RelayKind.circleRelay)
          .then((isConnected) {
        circleConnectCallback?.call(isConnected);
      });
      return;
    }
